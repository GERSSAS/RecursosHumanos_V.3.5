                    ...
                    <div class="row justify-content-start">
                        ...
                        <div class="col-md-6">
                            ...
                            <label class="titulos negrita"></label>Certificado <label>
                                <br>
                                <!-- <a id="hojaVida" type="button" title="Visor hoja de vida" href="<?php echo 'https://'.$_SERVER['HTTP_HOST'].'/RecursosHumanos'.$form['form_titulo_profesional']?>" class="radios modalhojadevida btn btn-info"><i class="fa fa-eye"></i></a> -->
                                <a id='consultarcertificao' type='button'  target="_black" href="<?php echo 'https://'.$_SERVER['HTTP_HOST'].'/RecursosHumanos'.$form['form_titulo_profesional']?>" class='btn btn-primary radios'><i class='fa fa-eye'></i></a>
                        </div>
